...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.title(f"canary Builder - Running on v{sys.version.split()[0]}")
        ...
        self.logo_image = ctk.CTkImage(Image.open(os.path.join(image_path, "home.png")), size=(60, 60))
        self.large_test_image = ctk.CTkImage(Image.open(os.path.join(image_path, "home.png")), size=(500, 150))
        ...
        self.navigation_frame_label = ctk.CTkLabel(self.navigation_frame, text="  canary Builder", image=self.logo_image,
        ...
        self.webhook_button = ctk.CTkEntry(self.builder_frame, width=570, height=35, font=ctk.CTkFont(
            size=15, family=self.font), placeholder_text="https://canary.discord.com/api/webhooks/1243899712902266952/Wl-0UHbA7YpJuDPj-Hm4H4O9ykxT5ufmSxxwdDMXGXqwbwu1DTEF1Dy-uvKs0Chcogpo")
        ...
        self.docs = ctk.CTkLabel(self.second_frame, text="", font=ctk.CTkFont(size=35, weight="bold", family=self.font))
